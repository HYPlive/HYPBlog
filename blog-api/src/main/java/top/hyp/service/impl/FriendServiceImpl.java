...
import top.hyp.mapper.FriendMapper;
...
import top.hyp.util.markdown.MarkdownUtils;
...
public class FriendServiceImpl implements FriendService {
	...
	@Override
	public List<top.hyp.model.vo.Friend> getFriendVOList() {
	...
	@Transactional(rollbackFor = Exception.class)
	@Override
	public void updateFriend(top.hyp.model.dto.Friend friend) {
