package top.hyp.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import top.hyp.entity.ScheduleJobLog;
import top.hyp.service.ScheduleJobService;
import top.hyp.util.common.SpringContextUtils;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		top.hyp.entity.ScheduleJob scheduleJob = (top.hyp.entity.ScheduleJob) context.getMergedJobDataMap().get(top.hyp.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
