package top.hyp.util.comment;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.context.annotation.DependsOn;
import org.springframework.stereotype.Component;
import top.hyp.config.properties.BlogProperties;
import top.hyp.constant.PageConstants;
import top.hyp.constant.RedisKeyConstants;
import top.hyp.entity.User;
import top.hyp.model.dto.Comment;
import top.hyp.model.vo.FriendInfo;
import top.hyp.service.AboutService;
import top.hyp.service.BlogService;
import top.hyp.service.FriendService;
import top.hyp.service.RedisService;
import top.hyp.service.UserService;
import top.hyp.util.HashUtils;
import top.hyp.util.IpAddressUtils;
import top.hyp.util.MailUtils;
import top.hyp.util.QQInfoUtils;
import top.hyp.util.StringUtils;
import top.hyp.util.comment.channel.ChannelFactory;
import top.hyp.util.comment.channel.CommentNotifyChannel;
import top.hyp.enums.CommentOpenStateEnum;
import top.hyp.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, top.hyp.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(top.hyp.entity.Comment parentComment, Comment comment) {
