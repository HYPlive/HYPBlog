...
import top.hyp.config.properties.TelegramProperties;
import top.hyp.entity.Comment;
import top.hyp.entity.Moment;
import top.hyp.enums.CommentPageEnum;
import top.hyp.service.CommentService;
import top.hyp.service.MomentService;
import top.hyp.util.comment.CommentUtils;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			top.hyp.model.dto.Comment comment = new top.hyp.model.dto.Comment();
